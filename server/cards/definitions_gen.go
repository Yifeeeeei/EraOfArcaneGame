...
func (CardDef1011003) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "传奇-巫师",
		Description:     "入场:获得等同于所有相邻伙伴的负载.绑定技能:纯净奥术",
...
func (CardDef1021008) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "精灵",
		Description:     "回合开始抽牌前,你可以查看牌堆顶的1张牌,将其放回牌堆顶或牌堆底",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 2},
		ElementsGain:    map[string]int{"无": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1021010) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "巫师",
		Description:     "入场:选择1个属性,此卡的负载变为该种属性",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 4},
...
func (CardDef1021012) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "人类",
		Description:     "绝技:从你的手牌或者装备区弃置1张道具牌,抽2张牌",
...
func (CardDef1021017) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "巫师",
		Description:     "入场:丢弃1张手牌,检索1个符文或卷轴",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 2},
		ElementsGain:    map[string]int{"无": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1111002) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "传奇-巫师",
		Description:     "每当对方召唤1个伙伴,使其获得点燃1和石化1",
...
func (CardDef1121003) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "人类",
		Description:     "消耗:使你的1个法术在本回合+2\\威",
		Quote:           "",
...
func (CardDef1121010) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "巫师",
		Description:     "绝技:消耗此卡,重置你的另1张人物牌以外的火焰牌",
		Quote:           "\"红色的火焰?那也太低级了!\"",
		ElementsCost:    map[string]int{"火": 3},
		ElementsGain:    map[string]int{"火": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1121012) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "巫师",
		Description:     "回合技:若有单位受到火焰伤害,抽1张牌",
		Quote:           "",
		ElementsCost:    map[string]int{"火": 3},
		ElementsGain:    map[string]int{"火": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1121013) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "巫师",
		Description:     "回合技:在你使用1个火焰法术后,使法力范围内的1个单位点燃1",
...
func (CardDef1211002) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "传奇-异兽-深渊",
		Description:     "消耗:消灭法力范围内1个伙伴,下个你的回合不能使用此效果",
...
func (CardDef1211003) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "传奇-巫师",
		Description:     "引魔.回合技3:在你检索1张水纹卡牌后,使1个前排敌人冻结1",
...
func (CardDef1221006) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "野兽",
		Description:     "在本卡相邻有2个及以上水纹伙伴时,本卡负载+1\\水",
		Quote:           "",
		ElementsCost:    map[string]int{"水": 2},
		ElementsGain:    map[string]int{"水": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1221011) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "巫师",
		Description:     "绝技:本回合你的下一次法术获得冻结1",
		Quote:           "",
		ElementsCost:    map[string]int{"水": 3},
		ElementsGain:    map[string]int{"水": 2},
		ElementsExpense: map[string]int{},
...
func (CardDef1311001) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "传奇-野兽",
		Description:     "入场:翻开卡组顶8张牌,抽取其中入场花费小于3的卡牌,重洗你的卡组.回合结束时丢弃这些这些被抽取的卡牌",
		Quote:           "跨四境,御九霄",
...
func (CardDef1311002) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "传奇-巫师",
		Description:     "绑定技能:风暴之怒.在你的手牌数大于等于手牌上限时,风暴之怒视为已经生效",
		Quote:           "我并不操纵风暴,我就是风暴",
...
func (CardDef1321003) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "植物",
		Description:     "当你抽到此卡时,将其展示.入场:如果你在本回合抽到此卡,抽1张牌",
		Quote:           "",
		ElementsCost:    map[string]int{"气": 1},
		ElementsGain:    map[string]int{"气": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1321005) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "巫师",
		Description:     "绝技:丢弃任意数量的手牌,每张牌使你获得1\\气",
		Quote:           "",
...
func (CardDef1321010) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "异兽",
		Description:     "引魔.吞噬:3\\气.你的大气法术使用花费减少1\\气",
		Quote:           "",
		ElementsCost:    map[string]int{"气": 3},
		ElementsGain:    map[string]int{"气": 2},
		ElementsExpense: map[string]int{},
...
func (CardDef1321012) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "巫师",
		Description:     "回合技:在你使用1个大气技能后,抽1张牌",
		Quote:           "",
		ElementsCost:    map[string]int{"气": 4},
		ElementsGain:    map[string]int{"气": 2},
		ElementsExpense: map[string]int{},
...
func (CardDef1401001) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "衍生-植物",
		Description:     "精通2:献祭此卡并从你的手牌中召唤1个地脉伙伴(无需花费),它会继承此卡的生命和负载加成",
		Quote:           "",
		ElementsCost:    map[string]int{},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef1401002) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "衍生-野兽",
		Description:     "当友方单位受到敌方伤害后,可以从卡组或手牌召唤此卡,无需入场花费",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 2},
...
func (CardDef1411001) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "传奇-巫师",
		Description:     "绝技:当1个友方伙伴死亡时,召唤1个生命种子,它会继承该伙伴的所有生命和负载加成",
...
func (CardDef1421002) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "巫师",
		Description:     "此卡和相邻单位不受负面状态影响(仍可处于负面状态)",
		Quote:           "",
...
func (CardDef1421003) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "植物",
		Description:     "精通2,4:负载+1\\地或者+1\\血",
...
func (CardDef1421010) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "精灵",
		Description:     "你的卡牌每次获得负载,在此卡上放置1个标记.回合技:取除2个标记,抽1张牌",
		Quote:           "",
		ElementsCost:    map[string]int{"地": 2},
		ElementsGain:    map[string]int{"地": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef1511001) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "传奇-巫师",
		Description:     "绝技:选择法力范围内的1个敌方伙伴,支付其入场花费,获得其控制权",
...
func (CardDef1511003) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "传奇-异兽",
		Description:     "引魔.对方使用法术攻击时:该法术对天枢圣兽 珀伽索斯以外的友方单位造成伤害变为0",
		Quote:           "希望之名,慈悲之怀",
...
func (CardDef1611002) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "传奇-巫师",
		Description:     "每当你献祭或吞噬1个伙伴,根据其生命值在此卡上放置暗影标记物.绝技:选择法力范围内的1个伙伴,取除其生命值数量的暗影标记物并将其消灭",
...
func (CardDef1621004) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "巫师",
		Description:     "绝技:献祭你的1个伙伴,使另一个角色获得其生命值",
		Quote:           "\"又到了献祭的时刻......\"",
...
func (CardDef1621006) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "恶魔",
		Description:     "每当其他友方单位死亡,此卡获得+1\\血",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 4},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef1621009) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "巫师",
		Description:     "回合技:在你的1个伙伴死亡后,检索1个暗影造物或恶魔",
		Quote:           "",
...
func (CardDef1621013) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "造物",
		Description:     "回合技:对方在1回合内使用第3个技能后,使那些技能虚弱1",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 6},
...
func (CardDef2011001) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "传奇-装备-武器",
		Description:     "入场:从你的技能池将1个法术置于此卡上.绝技:花费元素使用此卡上的1个技能,然后将该卡牌从游戏中移除",
...
func (CardDef2011002) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "传奇-装备-饰物",
		Description:     "入场:此后你召唤的所有伙伴负载变为0",
...
func (CardDef2011003) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "传奇-装备-防具",
		Description:     "绝技:当敌方法术命中时,如果你场上的负载多于敌方,每多2点使本回合所有敌方法术-1\\攻",
...
func (CardDef2021003) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "装备-武器",
		Description:     "消耗:将你的1个使用花费小于3的法术重置",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 4},
		ElementsGain:    map[string]int{"无": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2021013) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "装备-武器",
		Description:     "你的法术攻击和强化攻击时+2\\威,你的法术无法用于防御",
...
func (CardDef2021020) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "装备-饰物",
		Description:     "你的人物的负载变为等量的奥术元素\\无",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 2},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2111001) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "传奇-装备-神器",
		Description:     "回合技:献祭最多3点\\火,每1点火使下一次火焰法术获得+1\\攻或者+3\\威",
...
func (CardDef2111002) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "传奇-装备-神器",
		Description:     "每当1个单位受到1点火焰伤害,放置1个火焰标记物.祈咒:移除此卡所有火焰标记物,根据数量执行以下效果.0个:摧毁此卡;1个:获得2\\火;2个:本回合你的火焰法术+2\\威;3个:本回合你的火焰法术+1\\攻;4个及以上:造成2点火焰伤害(不放置标记物)",
...
func (CardDef2121001) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "装备-神器",
		Description:     "入场:放置3个火焰标记物.回合技:取除1个火焰标记物,获得1\\火",
		Quote:           "",
		ElementsCost:    map[string]int{"火": 1},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2121007) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "装备-防具",
		Description:     "绝技:移除1个友方火焰单位所有负面状态",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 1, "火": 1},
		ElementsGain:    map[string]int{"火": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2211001) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "传奇-装备-神器",
		Description:     "将此卡从游戏中移除:复活你的1个死亡伙伴但只有1\\血",
...
func (CardDef2211002) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "传奇-装备-武器",
		Description:     "每当有玩家使用法术,可以花费1\\水在此卡上放置1个水纹标记物.绑定技能:凛冬将至",
		Quote:           "一箭霜降,两箭严寒",
...
func (CardDef2221001) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "装备-防具",
		Description:     "敌方法术命中时献祭:该法术伤害变为0",
		Quote:           "",
		ElementsCost:    map[string]int{"水": 2},
		ElementsGain:    map[string]int{"水": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2221012) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "装备-防具",
		Description:     "在你的人物与至少3个水纹伙伴相邻时,此卡负载+1\\水",
		Quote:           "",
		ElementsCost:    map[string]int{"水": 2},
		ElementsGain:    map[string]int{"水": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2311001) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "传奇-装备-神器",
		Description:     "你的卡牌入场花费和使用花费减少1\\气",
		Quote:           "四境雷动,不过弹指之间",
...
func (CardDef2311002) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "传奇-装备",
		Description:     "每当你抽1张牌,可以将其展示并在此卡上放置1个标记.你无法在当回合使用展示过的卡牌.回合技:移除3个标记,本回合你的大气法术获得+1\\攻或者晕眩1",
...
func (CardDef2321001) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "装备",
		Description:     "回合技3:当你抽到1张大气卡牌,你可以将其展示然后此卡临时获得负载1点\\气",
		Quote:           "",
		ElementsCost:    map[string]int{"气": 3},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2411001) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "传奇-装备-神器",
		Description:     "回合技:友方单位获得负载时使其+1\\血,或获得生命时使其负载+1\\地",
...
func (CardDef2411002) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "传奇-装备-武器",
		Description:     "消耗:本回合下一次法术获得+4\\威且范围变为前排,或者+2\\攻且范围变为纵列",
...
func (CardDef2421001) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "装备-武器",
		Description:     "当你的卡牌达到精通时可以消耗此卡:抽1张牌并获得1\\地",
		Quote:           "",
		ElementsCost:    map[string]int{"地": 2},
		ElementsGain:    map[string]int{"地": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2421013) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "装备",
		Description:     "你原始入场花费大于5的卡牌入场费用减少2\\地,如果你装备了2张《地理学入门》,它们共计只能使入场费用减少3\\地",
		Quote:           "",
		ElementsCost:    map[string]int{"地": 3},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2511002) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "传奇-装备-防具",
		Description:     "你在防御时额外获得2\\威.回合技:当你防御成功时,对法力范围内所有敌人造成晕眩1",
...
func (CardDef2601001) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "衍生-装备-神器",
		Description:     "回合技:当敌方使用法术防御成功后,使用于防御和强化防御的法术虚弱2",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 2},
		ElementsGain:    map[string]int{"暗": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2611001) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "传奇-装备-神器",
		Description:     "回合技:当1个友方伙伴死亡,此卡获得负载+1\\暗",
...
func (CardDef2621002) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "装备",
		Description:     "在此卡上放置3个暗影标记物并选择法力范围内的2个伙伴,其一受到伤害时可以让另一者收到同等的伤害,并取除伤害数量的暗影标记物",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 2},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2621004) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "装备",
		Description:     "敌方法术命中时献祭:这个回合你的暗影伙伴不会受到法术伤害,但你的人物会获得引魔",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 1},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{},
...
func (CardDef2621006) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "装备-饰物",
		Description:     "回合技:当你的1个伙伴死亡时,获得1\\暗",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 2},
		ElementsGain:    map[string]int{"暗": 1},
		ElementsExpense: map[string]int{},
...
func (CardDef2621013) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "装备-饰物",
		Description:     "回合技:当敌方1个法术受到虚弱时,使该虚弱层数+1",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 4},
		ElementsGain:    map[string]int{"暗": 2},
		ElementsExpense: map[string]int{},
...
func (CardDef3021004) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "咒术-代赎",
		Description:     "冷却1.丢弃1张手牌,从卡组上方开始,抽取翻出的第1张卷轴或符文",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 1},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"无": 1},
...
func (CardDef3021007) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "咒术-幻变",
		Description:     "使你的下一次法术获得1点任意负面效果(点燃、冻结、麻痹、石化、虚弱)",
		Quote:           "",
		ElementsCost:    map[string]int{"无": 1},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"无": 1},
...
func (CardDef3021008) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "法术-驱动",
		Description:     "速攻.冷却1.命中敌方单位:摧毁敌方的1个装备",
		Quote:           "除你武器!",
		ElementsCost:    map[string]int{"无": 2},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"无": 2},
...
func (CardDef3221008) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "咒术-幻变",
		Description:     "冷却1.当对方使用法术时使用,使其中1个\\威变为0",
		Quote:           "",
		ElementsCost:    map[string]int{"水": 2},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"水": 2},
...
func (CardDef3321008) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "咒术-创造",
		Description:     "冷却1.当敌方的非范围法术命中时使用,将其无效",
		Quote:           "",
		ElementsCost:    map[string]int{"气": 2},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"气": 2},
...
func (CardDef3421012) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "法术-驱动",
		Description:     "穿透.你的伙伴每负载1点\\地获得+1\\威",
		Quote:           "",
		ElementsCost:    map[string]int{"地": 7},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"地": 3},
...
func (CardDef3421013) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "法术-灵媒",
		Description:     "冷却1.范围:全场.你的场上每有1个负载或生命大于3的伙伴,获得+1\\攻",
		Quote:           "",
...
func (CardDef3521002) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "法术-创造",
		Description:     "对友方单位不造成伤害,改为移除所有负面状态",
		Quote:           "",
...
func (CardDef3621007) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "法术-神秘",
		Description:     "每当友方单位受到1点伤害,下一次此技能获得+1\\威",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 4},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"暗": 2},
...
func (CardDef3621008) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "法术-聚能",
		Description:     "每当1个伙伴死亡,此法术获得+1\\威",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 4},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"暗": 2},
...
func (CardDef3621010) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "咒术-代赎",
		Description:     "冷却1.献祭你的1个伙伴:对前排所有敌人造成该伙伴生命值的伤害",
		Quote:           "",
		ElementsCost:    map[string]int{"暗": 4},
		ElementsGain:    map[string]int{},
		ElementsExpense: map[string]int{"暗": 2},
...
func (CardDef3621015) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "咒术-聚能",
		Description:     "冷却2.当敌方法术命中时使用,将造成的伤害改为回复生命值",
		Quote:           "",
...
func (CardDef4011001) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "",
		Description:     "回合技:丢弃1张手牌,获得2点该卡牌属性种类的元素,对于奥术以外的属性这个效果只能使用1次",
...
func (CardDef4011002) Card() model.Card {
	return model.Card{
		...
		Category:        "无",
		Tag:             "",
		Description:     "每当你让1张与你场上原有卡牌属性相同的卡牌入场,你受到1点伤害",
		Quote:           "凡有所相,皆是虚妄",
		ElementsCost:    map[string]int{},
...
func (CardDef4111001) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "",
		Description:     "在游戏开始前,将万火合一术置于你的技能池",
...
func (CardDef4111002) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "",
		Description:     "回合技:你获得点燃1,然后仅在本回合,将此卡负载的1\\火变为1\\无",
...
func (CardDef4111003) Card() model.Card {
	return model.Card{
		...
		Category:        "火",
		Tag:             "",
		Description:     "绝技:本回合每当你的火焰法术命中,此卡获得负载+1\\火",
...
func (CardDef4211001) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "",
		Description:     "绝技:本回合你将要打出的下一张手牌属性视为水,入场花费和负载的元素全部变为等量的\\水",
...
func (CardDef4211002) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "",
		Description:     "在游戏开始前,将百川归海置于你的技能",
...
func (CardDef4211003) Card() model.Card {
	return model.Card{
		...
		Category:        "水",
		Tag:             "",
		Description:     "绝技:在本回合剩余时间内,你技能区内的法术获得冻结1",
...
func (CardDef4311001) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "",
		Description:     "绝技:丢弃2张大气手牌,对任意1名敌人造成1点伤害",
...
func (CardDef4311003) Card() model.Card {
	return model.Card{
		...
		Category:        "气",
		Tag:             "",
		Description:     "绝技:选择法力范围内双方各1个伙伴,花费它们入场费用差值的\\气,将它们移回手牌",
...
func (CardDef4411001) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "",
		Description:     "你可以用检索1张地属性野兽、植物或精灵来代替你首个回合的回合开始抽牌",
...
func (CardDef4411002) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "",
		Description:     "在游戏开始前,将灵兽 辛柯置于你的牌组",
...
func (CardDef4411003) Card() model.Card {
	return model.Card{
		...
		Category:        "地",
		Tag:             "",
		Description:     "你的打出或学习的第一张原始费用大于5的卡牌费用减少2\\地",
...
func (CardDef4511001) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "",
		Description:     "绝技:当敌方造成伤害时,直到你的下个回合结束,每当你的单位受到对方伤害,获得2\\光",
...
func (CardDef4511002) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "",
		Description:     "在游戏开始前:将5张桎梏置于对手的牌组,当全部被解除(进入弃牌堆)时获得绝技:移除场上最多3张人物牌以外的卡牌",
...
func (CardDef4511003) Card() model.Card {
	return model.Card{
		...
		Category:        "光",
		Tag:             "",
		Description:     "在游戏开始前,用\"团结的希望\"替换你的技能池中的\"希望呼唤\"",
		Quote:           "\"选择与被选择,都是一种奢侈\"",
		ElementsCost:    map[string]int{},
		ElementsGain:    map[string]int{"光": 4},
		ElementsExpense: map[string]int{},
...
func (CardDef4611001) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "",
		Description:     "回合技:当1个你的伙伴死亡,使你的1个法术+1\\威",
...
func (CardDef4611002) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "",
		Description:     "绝技:使你的1个伙伴攻击和负载翻倍,但会在回合结束时死亡",
...
func (CardDef4611003) Card() model.Card {
	return model.Card{
		...
		Category:        "暗",
		Tag:             "",
		Description:     "游戏开始前,将三张咒言书洗入你的卡组",
